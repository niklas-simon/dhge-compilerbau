...
///////////////////////////////////////////////////////////////////////////////
  ...
  keyw_done,
  keyw_counter,
  keyw_countfrom = keyw_subfrom,
  keyw_countto = keyw_counter + 1,
  keyw_downto,
  keyw_step,
  keyw_while,
  keyw_repeat,
  keyw_until = keyw_countto,
  keyw_endpath = keyw_repeat + 1,
  keyw_calculation,
  keyw_returns,
  keyw_endcalc,
  keyw_begin,
  ...
  keyw_counter,
  keyw_countfrom = keyw_subfrom,
  keyw_countto = keyw_addto,
  keyw_downto = keyw_counter + 1,
  keyw_step,
  keyw_while,
  keyw_repeat,
  keyw_until,
...
typedef treenode_t* args_t[MAX_ARGS];
typedef nameentry_t* params_t[MAX_ARGS];
